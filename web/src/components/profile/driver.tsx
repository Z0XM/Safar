  ...
  return (
    <main className="flex h-[90vh] w-screen flex-row text-sm">
      <div className="flex w-[40vw] flex-col gap-8 overflow-y-scroll border-r-2 border-r-gray-200 p-8">
        <div className="">
          <div className="mb-2 ml-4 text-safar-orange">My Details</div>
        ...
        <div className="">
          <div className="mb-2 ml-4 text-safar-orange">Earnings</div>
          <div className="flex w-full flex-row justify-between gap-4">
            <div className="flex flex-1 flex-row items-center justify-between rounded-lg border-2 border-gray-200 p-4">
              <div>
                Total Earnings{" "}
                <span className="font-bold text-safar-orange">₹2400</span>
              </div>
              <div>
                Debited Money{" "}
                <span className="font-bold text-safar-orange">₹1600</span>
              </div>
              <div>
                Remaining Earnings{" "}
                <span className="font-bold text-safar-orange">₹800</span>
              </div>
            </div>
          </div>
        </div>
        <div className="">
          ...
          <div className="flex w-full flex-row justify-between gap-4">
            <div className="flex flex-1 flex-row items-center rounded-lg border-2 border-gray-200 p-4">
              ...
              <div className="flex flex-col items-center justify-evenly gap-2">
                <div className="text-4xl text-safar-orange">75</div>
                <div>Total Rides</div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex w-full flex-row justify-between gap-4">
              <div className="flex flex-1 flex-row items-center justify-between gap-4 rounded-lg border-2 border-gray-200 p-4">
                <div>
                  Basic Fair{" "}
                  <span className="font-bold text-safar-orange">₹20</span>
                </div>
                <div>
                  Per Km{" "}
                  <span className="font-bold text-safar-orange">₹12</span>
                </div>
              </div>
            </div>
          </div>
          <div className="flex-1">
            <div className="mb-2 ml-4 text-safar-orange">Availablity</div>
            <div className="flex w-full flex-row justify-between gap-4">
              <div className="flex flex-1 flex-row items-center justify-between gap-4 rounded-lg border-2 border-gray-200 p-4">
        ...
        <button className="flex w-full flex-row items-center justify-center gap-4 rounded-lg bg-safar-orange px-4 py-4 text-safar-white">
      ...
      <div className="flex w-[60vw] flex-col">
        <div className="h-[50%] overflow-x-auto overflow-y-hidden border-b-2 border-b-gray-200 p-8">
          <div className="text-safar-orange">Verified documents</div>
        ...
        <div className="h-[50%] overflow-y-auto p-8">
          <div className="mb-4 text-safar-orange">Previous rides</div>
          <div className="flex flex-col gap-4">
            <div className="flex flex-row justify-between rounded-lg border-2 border-gray-200 p-4">
              ...
              <div className="flex flex-col items-center">
                <div className="text-safar-orange">₹360</div>
